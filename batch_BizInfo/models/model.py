...
t_stm_fld = Table(
    ...
    Column('building_division', String(2), comment='건물구분'),
    ...
    Column('worker_num_standard_under_yn', String(2), comment='상시 근로자수 기준 미만 여부'),
    Column('worker_num', String(100), comment='상시 근로자수'),
    Column('sales_standard_under_yn', String(2), comment='매출액 기준 미만 여부'),
    Column('sales', String(100), comment='매출액(백만원)'),
    Column('biz_no', String(100), comment='사업자번호'),
    Column('termsA1', String(2), comment='소비자권익에 관한사항'),
    Column('termsA2', String(2), comment='단체규약'),
    Column('termsA3', String(2), comment='민감정보 및 고유식별정보의 처리에 관한 사항'),
    Column('termsA4', String(2), comment='개인(신용)정보의 사전 수집.이용에 관한 사항'),
    Column('termsA6', String(2), comment='개인(신용)정보의 조회에 관한 사항'),
    Column('termsA7', String(2), comment='개인(신용)정보의 제공에 관한 사항'),
    Column('imputation_reason_confirm_yn', String(2), comment='귀책 사유 확인'),
