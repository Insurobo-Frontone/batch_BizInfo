from sqlalchemy import CHAR, Column, Date, DateTime, Double, ForeignKeyConstraint, Index, LargeBinary, MetaData, String, TIMESTAMP, Table, Text, text
...
t_BATCH_JOB_INSTANCE = Table(
    ...
    Column('JOB_INSTANCE_ID', BIGINT(20), primary_key=True),
...
t_IN011TR = Table(
    'IN011TR', metadata,
    Column('QUOTE_NO', String(191), primary_key=True),
    Column('INS_DATE', DateTime, nullable=False, server_default=text('current_timestamp()')),
    Column('TERMSA_1', String(191)),
    Column('TERMSA_2', String(191)),
    Column('TERMSA_3', String(191)),
    Column('TERMSA_4', String(191)),
    Column('TERMSA_5', String(191)),
    Column('TERMSA_6', String(191)),
    Column('TERMSA_7', String(191)),
    Column('TERMSA_8', String(191)),
    Column('TERMSB_1', String(191)),
    Column('TERMSB_2', String(191)),
    Column('TERMSB_3', String(191)),
    Column('TERMSC_1', String(191)),
    Column('TERMSC_2', String(191)),
    Column('TERMSC_3', String(191)),
    Column('TERMSC_4', String(191)),
    Column('TERMSC_5', String(191)),
    Column('TERMSD_1', String(191)),
    Column('TERMSD_2', String(191)),
    Column('TERMSD_3', String(191)),
    Column('TERMSE_1', String(191)),
    Column('TERMSE_2', String(191)),
    Column('TERMSE_3', String(191)),
    Column('TERMSF_1', String(191)),
    Column('TERMSG_1', String(191))
)

t_IN101CR = Table(
    'IN101CR', metadata,
    Column('IDX', INTEGER(11), primary_key=True),
    Column('CODE', String(191), nullable=False),
    Column('NAME', String(191), nullable=False)
)

t_IN101TR = Table(
    'IN101TR', metadata,
    Column('QUOTE_NO', INTEGER(11), primary_key=True),
    Column('USER_ID', String(191)),
    Column('INR_BIRTH', String(191), nullable=False),
    Column('INR_GENDER', String(191), nullable=False),
    Column('EMAIL', String(191)),
    Column('AGMTKIND', String(191)),
    Column('BLDTOTLYRNUM', String(191)),
    Column('HSAREA', String(191)),
    Column('LSGCCD', String(191)),
    Column('POLESTRC', String(191)),
    Column('ROOFSTRC', String(191)),
    Column('OTWLSTRC', String(191)),
    Column('OBJCAT', String(191)),
    Column('BLDFLOORS1', String(191)),
    Column('BLDFLOORS2', String(191)),
    Column('LOBZCD', String(191)),
    Column('GITDTARIFCAT1', String(191)),
    Column('OBJTYPCD1', String(191)),
    Column('OBJTYPCD2', String(191)),
    Column('OBJTYPCD3', String(191)),
    Column('ELAGORGNINSDAMT1', String(191)),
    Column('ELAGORGNINSDAMT2', String(191)),
    Column('ELAGORGNINSDAMT3', String(191)),
    Column('PTYKORNM', String(191)),
    Column('TELCAT', String(191)),
    Column('TELNO', String(191)),
    Column('PTYBIZNM', String(191)),
    Column('BIZNO', String(191)),
    Column('OBJONNADDRCAT', String(191)),
    Column('OBJZIP', String(191)),
    Column('OBJADDR1', String(191)),
    Column('OBJADDR2', String(191)),
    Column('OBJROADNMCD', String(191)),
    Column('OBJTRBDCD', String(191)),
    Column('OBJTRBDADDR', String(191)),
    Column('PARTNERNO', String(191)),
    Column('TPYMPREM', String(191)),
    Column('PERPREM', String(191)),
    Column('GOVTPREM', String(191)),
    Column('LGOVTPREM', String(191)),
    Column('APPLNO', String(191)),
    Column('SCNO', String(191)),
    Column('INSERT_DATE', DateTime, nullable=False, server_default=text('current_timestamp()')),
    Column('PURPOSE', String(191)),
    Column('LOCALURLTMP', String(191)),
    Column('MAPPINGNO', String(191)),
    Column('INSSTDT', String(191)),
    Column('INSEDDT', String(191)),
    Column('INSSTTM', String(191)),
    Column('INSEDTM', String(191)),
    Column('PRDINS', String(191)),
    Column('SESSIONEXECTIME', String(191)),
    Column('SESSIONID', String(191)),
    Column('CERTCONFMSEQNO', String(191)),
    Column('ESIGNURL', String(191)),
    Column('GIID0410VO_JSON', String(191))
)

t_IN103CR = Table(
    'IN103CR', metadata,
    Column('CODE', String(191), primary_key=True),
    Column('OBJ_TYPE', String(191), nullable=False),
    Column('NAME', String(191), nullable=False),
    Column('SEQ', INTEGER(11), nullable=False)
)
...
t_stm_fld = Table(
    ...
    Column('worker_num_standard_under_yn', String(100), comment='상시 근로자수 기준 미만 여부'),
    Column('worker_num', String(100), comment='상시 근로자수'),
    Column('sales_standard_under_yn', String(100), comment='매출액 기준 미만 여부'),
    Column('biz_main_type', String(100), comment='주요업종'),
    Column('sales', String(100), comment='매출액(백만원)'),
    Column('biz_no', String(100), comment='사업자번호'),
    Column('termsA1', String(100), comment='소비자권익에 관한사항'),
    Column('termsA2', String(100), comment='단체규약'),
    Column('termsA3', String(100), comment='민감정보 및 고유식별정보의 처리에 관한 사항'),
    Column('termsA4', String(100), comment='개인(신용)정보의 사전 수집.이용에 관한 사항'),
    Column('termsA6', String(100), comment='개인(신용)정보의 조회에 관한 사항'),
    Column('termsA7', String(100), comment='개인(신용)정보의 제공에 관한 사항'),
    Column('imputation_reason_confirm_yn', String(100), comment='귀책 사유 확인'),
    Column('create_date', String(50), comment='생성일자'),
    Column('termsA8', String(100), comment='마케팅이용 동의에 관한사항(선택)'),
    Column('difStmFldJoinYn', CHAR(2)),
    Column('phoneNum', String(50)),
...
t_tb_agreement = Table(
    ...
    Column('id', BIGINT(20), primary_key=True, comment='시퀀스'),
...
t_tb_infoplace = Table(
    ...
    Column('id', BIGINT(20), primary_key=True, comment='번호'),
...
t_tb_insu_status = Table(
    ...
    Column('PER_PREM', INTEGER(11)),
    Column('GOVT_PREM', INTEGER(11)),
    Column('LGOVT_PREM', INTEGER(11)),
    Column('TPYM_PREM', INTEGER(11)),
...
t_tb_manager = Table(
    'tb_manager', metadata,
    Column('id', INTEGER(11), primary_key=True, comment='번호'),
    ...
    Column('updated_date', DateTime),
    Column('updated_by', String(20)),
    Column('error_count', INTEGER(11), server_default=text('0')),
    Column('delete_yn', CHAR(1), server_default=text("'N'"), comment='삭제 여부'),
...
t_tb_payment_status = Table(
    ...
    Column('id', INTEGER(11), primary_key=True),
    Column('dt_id', BIGINT(20), comment='tb_domestic_tour table join FK'),
    Column('merchant_uid', String(50), nullable=False, comment='가맹점 주문번호'),
    Column('amount', INTEGER(11), nullable=False, comment='결제 금액'),
...
t_tb_trip_bojang = Table(
    ...
    Column('id', BIGINT(20), primary_key=True),
    Column('b_code', INTEGER(11)),
    Column('b_name', String(100)),
    Column('b_money', INTEGER(11)),
    Column('b_self_money', INTEGER(11)),
    Column('b_flag', CHAR(1), comment='1:알뜰 2:기본 3:고급'),
    Column('b_due_date', TIMESTAMP),
    Column('b_order', INTEGER(11)),
    Column('category', INTEGER(11)),
...
t_tb_trip_fee = Table(
    ...
    Column('fee', INTEGER(11), nullable=False),
...
t_BATCH_JOB_EXECUTION = Table(
    ...
    Column('JOB_EXECUTION_ID', BIGINT(20), primary_key=True),
    Column('VERSION', BIGINT(20)),
    Column('JOB_INSTANCE_ID', BIGINT(20), nullable=False),
...
t_BATCH_JOB_EXECUTION_PARAMS = Table(
    ...
    Column('JOB_EXECUTION_ID', BIGINT(20), nullable=False),
...
t_BATCH_STEP_EXECUTION = Table(
    ...
    Column('STEP_EXECUTION_ID', BIGINT(20), primary_key=True),
    Column('VERSION', BIGINT(20), nullable=False),
    Column('STEP_NAME', String(100), nullable=False),
    Column('JOB_EXECUTION_ID', BIGINT(20), nullable=False),
    Column('START_TIME', DATETIME(fsp=6), nullable=False),
    Column('END_TIME', DATETIME(fsp=6)),
    Column('STATUS', String(10)),
    Column('COMMIT_COUNT', BIGINT(20)),
    Column('READ_COUNT', BIGINT(20)),
    Column('FILTER_COUNT', BIGINT(20)),
    Column('WRITE_COUNT', BIGINT(20)),
    Column('READ_SKIP_COUNT', BIGINT(20)),
    Column('WRITE_SKIP_COUNT', BIGINT(20)),
    Column('PROCESS_SKIP_COUNT', BIGINT(20)),
    Column('ROLLBACK_COUNT', BIGINT(20)),
    Column('EXIT_CODE', String(2500)),
    Column('EXIT_MESSAGE', String(2500)),
    Column('LAST_UPDATED', DATETIME(fsp=6)),
